...
namespace Homework_Theme_04
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            #region Matrix multiplication commented
    ...
    */
            ...
            #region Pascal triangle commented
    ...
    */
            ...
            //TO DO: 
            //Исключить повторение индексов в их массиве после применения IndexOf().


            //
            //Если на i-ом шаге в indices уже присутствует indices[i], то начинаем вложенный цикл поиска с этого же элемента и до конца,
            //
